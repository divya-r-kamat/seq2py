...
def translate_sentence(sentence, src_field, trg_field,trg_itos, model, device, max_len = 500):
...
def predict_sentence(sentence, src_field, trg_field, model, device, max_len = 500):
